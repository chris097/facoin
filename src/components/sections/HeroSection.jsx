        ...
        <div className='flex items-center'>
          <div className='relative'>
            ...
            <div className="mt-4 mb-8">
              <p className="text-slate-300">Buy and sell 200+ cryptocurrencies with 20+ flat currencies using</p>
              <p className="text-slate-300">bank transfers or your credit/debit card.</p>
            </div>
